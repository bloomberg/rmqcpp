...
TEST(Methods_Queue_Unbind_Ok, QueueUnbindOkEncodeDecode)
{
    QueueUnbindOk method;
    ...
    ASSERT_TRUE(qm.is<rmqamqpt::QueueUnbindOk>());
    EXPECT_EQ(method, qm.the<rmqamqpt::QueueUnbindOk>());
}
