...
TEST(Methods_Queue_Declare_Ok, QueueDeclareOkEncodeDecode)
{
    QueueDeclareOk method("queue", 0, 0);
    ...
    ASSERT_TRUE(qm.is<rmqamqpt::QueueDeclareOk>());
    EXPECT_EQ(method, qm.the<rmqamqpt::QueueDeclareOk>());
}
