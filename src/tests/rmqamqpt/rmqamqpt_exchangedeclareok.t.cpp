...
TEST(Methods_Exchange_Declare_Ok, ExchangeDeclareOkEncodeDecode)
{
    ExchangeDeclareOk method;
    ...
    ASSERT_TRUE(qm.is<rmqamqpt::ExchangeDeclareOk>());
    EXPECT_EQ(method, qm.the<rmqamqpt::ExchangeDeclareOk>());
}
