                           ...
                           const ErrorCallback& onFail)
{
    ...
    bsl::shared_ptr<AsioConnection<AsioSocket> > connection =
        bsl::shared_ptr<AsioConnection<AsioSocket> >(
            new AsioConnection<AsioSocket>(
                socket,
                connCallbacks,
    ...
    const ErrorCallback& onFail)
{
    ...
    connection = bsl::shared_ptr<AsioConnection<AsioSecureSocketWrapper> >(
        new AsioConnection<AsioSecureSocketWrapper>(
            socket,
            connCallbacks,
            bslma::ManagedPtrUtil::makeManaged<Decoder>(maxFrameSize)));
