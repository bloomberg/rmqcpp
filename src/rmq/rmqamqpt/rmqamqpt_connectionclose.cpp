...
ConnectionClose::ConnectionClose(rmqamqpt::Constants::AMQPReplyCode replyCode,
...
bool ConnectionClose::decode(ConnectionClose* close,
                             const uint8_t* data,
...
void ConnectionClose::encode(Writer& output, const ConnectionClose& close)
{
...
{
    os << "Connection Close = [replyCode: " << closeMethod.replyCode()
